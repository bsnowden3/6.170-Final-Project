...
class Database {
  ...
  async createTables() {
    ...
    let createUserSleepScheduleTable = `CREATE TABLE IF NOT EXISTS userSleepRegimen(
    ...
    let createUserExerciseScheduleTable = `CREATE TABLE IF NOT EXISTS userExerciseRegimen(
